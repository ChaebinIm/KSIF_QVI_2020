...
class Transformer(Module):
    ...
    def __init__(self, d_model: int = 24, nhead: int = 4, nhead2: int = 1,
                 ...
                 column_num: int = 22, threshold: int = 0, activation: str = "relu",
...
################# plot : 지워야함! ##########################
        ...
        #     plt.subplot(221)
        #     plt.subplot(2, 2, 1)
        #     yy = winner_score.data.cpu().numpy()
        #     yy = (yy-np.mean(yy))/np.std(yy)
        #     yy = np.squeeze(yy, axis = 1)
        #     yy.sort()
        #     plt.hist(yy, bins=100, color = 'black')
        #     plt.title('All epoch = ' + str(temp // 12))
        #
        #     plt.subplot(2, 2, 2)
        #     yy2 = yy[-100:]
        #     plt.hist(yy2, bins=10, color='red')
        #     plt.title('Top 100 epoch = ' + str(temp // 12))
        #
        #     plt.subplot(2, 2, 3)
        #     yy3 = yy[:100]
        #     plt.hist(yy3, bins=10, color='blue')
        #     plt.title('Low 100 epoch = ' + str(temp // 12))
        #
        #     plt.subplot(2, 2, 4)
        #     yy4 = yy[-20:]
        #     plt.hist(yy4, color='green')
        #     plt.title('Top 20 epoch = ' + str(temp // 12))
        #     plt.show()
        ...
        stocks = key_table.copy()[_stocks]  # Stocks to long in the key_table
